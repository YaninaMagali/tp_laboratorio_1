#ifndef REALIZAROPERACIONES_H_INCLUDED
#define REALIZAROPERACIONES_H_INCLUDED
float sumarNumeros(float primerOperador, float segundoOperador);
float dividirNumeros(float primerOperador, float segundoOperador);
